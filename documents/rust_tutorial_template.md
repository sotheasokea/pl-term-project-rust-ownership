...
-`data race (การเข้าถึงข้อมูลพร้อมกันจากหลาย thread โดยไม่ปลอดภัย)`<br>
...
`มีกฎ 3 ข้อ: `<br>
`(1) แต่ละค่ามีเจ้าของได้แค่หนึ่งเดียว `<br>
`(2) เมื่อ owner หลุด scope ค่านั้นถูก drop ทันที `<br>
`(3) มี owner ได้ทีละหนึ่งเท่านั้นในแต่ละเวลา`<br>
